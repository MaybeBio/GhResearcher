...
**来源页面:** [Understanding GitHub Code Search syntax - GitHub Docs](https://docs.github.com/en/search-github/github-code-search/understanding-github-code-search-syntax)
...
```
 ...
 To search for JavaScript files within a `src` directory, you could use: ```text
path:src/*.js
...
```
 ...
 To search for a filename which contains a special character like `*` or `?`, just use a quoted string: ```text
path:"file?"
